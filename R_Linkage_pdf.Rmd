...
output:
    pdf_document:
      ...
      toc: yes    
title: |   
  | \vspace{0.5cm} \LARGE Record Linkage Using R 
...
header-includes:
  ...
  - \pretitle{\begin{center}
    \includegraphics[width=2in,height=2in]{image/RSImage-329695.png}\LARGE\\}
  - \usepackage{caption}
  ...
  - \posttitle{\end{center}}
    ...
    \fancyhead[L]{\includegraphics[width=5cm]{image/RSImage-329695.png}}
---  
...
A user friendly HTML version of this document can be found [https://rpubs.com/Parrish_EPI/RecordLinkage](here). All source code, and files used in the linkages are available on github at  [https://github.com/parrish-epi/R-recordLinkage](https://github.com/parrish-epi/R-recordLinkage)
...
knitr::kable(dat1a.dedup %>% 
             arrange(FamilyName) %>%
             head(5), format = "latex", booktabs = TRUE,
             caption = "First five records of aligned dataset 1 (dat1)") %>%
...
knitr::kable(dat2a %>% 
             arrange(FamilyName) %>%
             head(5), format = "latex", booktabs = TRUE,
             caption = "First five records of aligned dataset 2 (dat2)") %>%
       kableExtra::kable_styling(latex_options = c("scale_down", "HOLD_position"))
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results='asis'}
 skim_summary <- capture.output(print(skimr::skim_without_charts(dat1a.dedup)))
cat("```", paste(skim_summary, collapse = "\n"), "```", sep = "\n")
```

**Skim function output for Dat2 - normalized**

```{r, echo=FALSE, warning=FALSE, message=FALSE, results='asis'}
skim_summary2 <- capture.output(print(skimr::skim_without_charts(dat2a)))
cat("```", paste(skim_summary2, collapse = "\n"), "```", sep = "\n")
```
...
```{r echo=FALSE, fig.cap="General Data Linkage Flow Diagram", fig.alt="General data linkage flow diagram.", out.width = '100%'}
...
knitr::kable(MergedDat %>% 
             arrange(FamilyName) %>%
             head(5), format = "latex", booktabs = TRUE,
             caption = "First five records of merged datasets") %>%
...
```{r echo=FALSE, fig.cap="Mean Residual Life (MRL) plot.",fig.alt="Image of Mean Residual Life (MRL) on y-axis, and threshold level.", out.width = '100%'}
knitr::include_graphics(
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, fig.cap="Histogram of counts by bin for possible matches.", fig.alt="Histogram of counts by bin for possible matches.",fig.width=10,fig.height=5}
...
```{r echo=FALSE, fig.cap="Image of potential matches from the r base editor.",fig.alt="Image of potential matches from the r base editor.", out.width = '100%'}
knitr::include_graphics(
...
email: [parrish.epi@gmail.com](mailto:parrish.epi@gmail.com)  
url: [https://github.com/parrish-epi/R-recordLinkage](https://github.com/parrish-epi/R-recordLinkage)  
